            ...
            <Flex  display="flex" flexDirection="column">
                {
                    Array.from({ length: 10 }, () => Math.random().toString()).map((_, i) => {
                        return <Flex key={i} border="1px solid #0088000f" _hover={{ backgroundColor: "#9ca3af3b", cursor: "pointer" }} justifyContent="stretch" alignItems="center" display="flex" height="50px" padding="5px" borderRadius="5px">
